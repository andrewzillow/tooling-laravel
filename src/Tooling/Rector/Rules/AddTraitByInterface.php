 ...
 */
final class AddTraitByInterface extends AbstractRector implements ConfigurableRectorInterface
{
    /**
    ...
    {
        return new RuleDefinition('Add trait by implemented interface', [new ConfiguredCodeSample(<<<'CODE_SAMPLE'
...
CODE_SAMPLE
    ...
    public function refactor(Node $node): null|Node
    {
        ...
        foreach ($this->traitByInterface as $interfaceName => $traitName) {
            ...
            $traitUse = new Node\Stmt\TraitUse([new FullyQualified($traitName)]);
